...
/*Text for model mapping*/

Text[0]=["CEPE","Hybrid mode: general equilibrium + dispatch model"]
Text[1]=["CITE","Dynamic general equilibrium model with endogenous growth"]
Text[2]=["Swissmod","Bottom-up electric system model"]
Text[3]=["SwissRes","Bottom-up simulation model of the Swiss residential sector"]
Text[4]=["TREES","System Dynamic model"]

Text[5]=["SCS","Bottom-up simulation model of the Swiss electric energy supply"]
Text[6]=["STEM","Bottom-up energy system model the Swiss electric energy supply"]

/*Space for other models*/
Text[7]=["sticky style","This tip will sticky around<BR>This is useful when you want to insert a link like this <A href='http://migoicons.tripod.com'>Home Page</A>"]
Text[8]=["keep style","This sticks around the mouse"]
Text[9]=["Left coordinate control","This tip is right positioned with a 40 X coordinate "]
Text[10]=["Top coordinate control","This tip is right positioned with a 50 Y coordinate"]
Text[11]=["Visual effects","This tip has a Shadow and is Transparent a little and also has a random Transition applied to it "]
Text[12]=["different style","Wow this is a new style and position! "]
Text[13]=["This is The title","this is the text"]
Text[14]=["","This is only text"]
Text[15]=["","Some Lists <li>list one</li> <li>list two</li> <li>list three</li> <li>list four</li>"]
Text[16]=["This is The title","this is the text"]
Text[17]=["","This is only text"]
Text[18]=["","This is only text"]
Text[19]=["This is The title","this is the text"]

/*CITE model*/
Text[20]=["Economic output","Economic sectors are modeled with a CES production function"]
Text[21]=["Intermediate composite","The endogenous sectoral growth mechanism is modeled through the increase in varieties of intermediate goods"]
...
/*Style for models*/
Style[20]=["white","black","#1E78B4","#eae7ed","","","","","","","","","","",200,"",2,2,10,10,"","","","",""]
